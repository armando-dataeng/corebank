...
Copyright (c) 2024 Ing. Armando Marrero



Se concede permiso, sin cargo alguno, a cualquier persona que obtenga una copia

de este software y archivos de documentación asociados (el "Software"), a utilizar
...
de copias del Software, y a permitir a las personas a las que se les proporcione
...
IMPLÁCITA, INCLUYENDO PERO NO LIMITADO A GARANTÍAS DE COMERCIABILIDAD,
